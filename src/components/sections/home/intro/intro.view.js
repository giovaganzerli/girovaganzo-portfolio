...
// IMPORT CONTROLLER
import { SectionIntroController } from './intro.controller';
...
class SectionIntro extends React.Component {
    ...
    constructor(props) {
        super(props);
        this.controller = SectionIntroController.create();
        this.dataMouse = props;
    }
    ...
    render() {
        return (
            <>
                <section id="intro" className="section section-intro is-flex is-align-items-center">
                    <div className="section-wrapper is-flex is-flex-direction-column is-align-items-center is-flex-grow-1">
                        <div className="intro-content is-flex is-flex-wrap-wrap is-flex-direction-column is-align-items-center">
                            <img src={this.controller.getProfileImage()} alt="" className="img-profile mb-4" />

                            <h1 className="is-uppercase has-text-primary has-text-centered">Giovanni Ganzerli</h1>
                                ...
                                <i>
                                    ...
                                    <Typed
                                        strings={[
                                            ...
                                            " maker",
                                            " cyclist",
                                            " Digital enthusiast &amp; Adventure lover"
                                        ]}
                                        typeSpeed={80}
                                        backSpeed={40}
                                    />
                            ...
                            <div className="mt-4">
                                <Link
                                    ...
                                    duration={500}
                                >
                                    Hire me <span className="ml-3" role="img" aria-label="">📬</span>
                                </Link>
                            </div>
                        </div>

                        <div className="intro-scroll_down">
                            <Link
                            ...
                            >
                                ...
                                <img src={iconMouse} alt="" style={{display: 'block', margin: '0 auto'}}/>
                            </Link>
                        </div>

                        <div className="intro-parallax" data-relative-input="true">
                            <svg
                                width="27"
                                height="29"
                                className="layer p1"
                                xmlns="http://www.w3.org/2000/svg"
                                style={this.controller.activeParallax(this.dataMouse, 15)}
                            >
                                <path
                            ...
                            <svg
                                ...
                                className="layer p2"
                                xmlns="http://www.w3.org/2000/svg"
                                style={this.controller.activeParallax(this.dataMouse, 20)}
                            >
                                <path
                            ...
                            <svg
                                ...
                                className="layer p3"
                                xmlns="http://www.w3.org/2000/svg"
                                style={this.controller.activeParallax(this.dataMouse, 25)}
                            >
                                <path
                            ...
                            <svg
                                ...
                                className="layer p4"
                                xmlns="http://www.w3.org/2000/svg"
                                style={this.controller.activeParallax(this.dataMouse, 10)}
                            >
                                <rect
                            ...
                            <svg
                                ...
                                className="layer p5"
                                xmlns="http://www.w3.org/2000/svg"
                                style={this.controller.activeParallax(this.dataMouse, 8)}
                            >
                                <rect
                                    transform="rotate(30 9.86603 10.13397)"
                                    x="7"
                            ...
                            <svg
                                ...
                                className="layer p6"
                                xmlns="http://www.w3.org/2000/svg"
                                style={this.controller.activeParallax(this.dataMouse, 18)}
                            >
                            ...
                            <svg
                                ...
                                className="layer p7"
                                xmlns="http://www.w3.org/2000/svg"
                                style={this.controller.activeParallax(this.dataMouse, 22)}
                            >
                                <path
                            ...
                            <svg
                                ...
                                className="layer p10"
                                xmlns="http://www.w3.org/2000/svg"
                                style={this.controller.activeParallax(this.dataMouse, 23)}
                            >
...
export default observer(SectionIntro);